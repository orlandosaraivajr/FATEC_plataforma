...
view_in_test = 'estagio:listar_ficha_avaliacao_estagiario'
template_in_test = 'listar_documentos.html'


class ListarFichaAvaliacaoEstagioNoAuthGet(TestCase):
    def setUp(self):
...
class ListarFichaAvaliacaoEstagioGetOk(TestCase, CreateTestUser):
    def setUp(self):
    ...
    def test_html(self):
        tags = (
            ...
            ('Ficha de avaliação do estagiário', 1),
