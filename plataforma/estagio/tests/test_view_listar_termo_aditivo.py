...
view_in_test = 'estagio:listar_termo_aditivo'
template_in_test = 'listar_documentos.html'


class ListarTermoAditivoNoAuthGet(TestCase):
    def setUp(self):
...
class ListarTermoAditivoGetOk(TestCase, CreateTestUser):
    def setUp(self):
    ...
    def test_html(self):
        tags = (
            ('Termo de compromisso de Estágio', 0),
