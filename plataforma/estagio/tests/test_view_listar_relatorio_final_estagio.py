...
view_in_test = 'estagio:listar_relatorio_final_estagio'
template_in_test = 'listar_documentos.html'


class ListarRelatorioFinalEstagioNoAuthGet(TestCase):
    def setUp(self):
...
class ListarRelatorioFinalEstagioGetOk(TestCase, CreateTestUser):
    def setUp(self):
