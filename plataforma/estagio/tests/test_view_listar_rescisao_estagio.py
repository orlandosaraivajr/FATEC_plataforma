...
view_in_test = 'estagio:listar_rescisao_de_contrato'
template_in_test = 'listar_documentos.html'


class ListarTermosCompromissoEstagioNoAuthGet(TestCase):
    def setUp(self):
...
class ListarTermosCompromissoEstagioGetOk(TestCase, CreateTestUser):
    def setUp(self):
    ...
    def test_html(self):
        tags = (
            ...
            ('Termo Aditivo', 0),
            ('Rescisão de Contrato', 2),
            ('Ficha de avaliação do estagiário', 0),
            ('Relatório Parcial de Estágio', 0),
            ('Relatório Final de Estágio', 0),
        )
