...
url_testada = 'vitrine:showcase_tipo_vaga'


class vitrine_tipo_vaga_Get_0_Ok(TestCase):
    def setUp(self):
...
class vitrine_tipo_vaga_Get_1_Ok(TestCase):
    def setUp(self):
...
class vitrine_tipo_vaga_Get_2_Ok(TestCase):
    def setUp(self):
